...
const Courses = () => {
	...
	return (
		<div className="grid grid-cols-12 gap-5 mt-5">
			<div className="right-side lg:col-span-4 col-span-12 bg-gradient-to-tr from-gray-900 via-purple-900 to-violet-600 rounded-tr-lg rounded-br-lg h-fit my-10 titles">
				<h2 className="text-3xl font-bold my-4 text-white">Course Titles</h2>
