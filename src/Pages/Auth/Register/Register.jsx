	...
	return (
		<div className="register-comp p-20 ">
			<div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
				...
				<form  className="space-y-6 ng- ">
					<div className="space-y-1 text-sm">
						<label for="username" className="block dark:text-gray-400 text-left mb-1">
							Full Name
						</label>
						<input
							type="text"
					...
					<div className="space-y-1 text-sm">
						<label for="password" className="block dark:text-gray-400 text-left mb-1">
							Password
						</label>
						<input
							type="password"
